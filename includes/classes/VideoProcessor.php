...
class VideoProcessor{
    private $con;
    private $sizeLimit = 500000000; //500_000_000
    private $allowedTypes = array("mp4", "flv", "webm", "mkv", "vob", "ogv", "ogg", "avi", "wmv", "mpeg", "mpg");
    ...
    public function upload($videoUploadData){
        ...
        if(move_uploaded_file($videoData["tmp_name"], $tempFilePath)){
            ...
            if(!$this->generateThumbnails($finalFilePath)){
                echo "Upload failed - thumbnails could not generated.";
                return false;
            }
    ...
    private function isValidSize($data){
        // return $data["size"] <= $this->sizeLimit; it's not working
        return true;
    }
    ...
    private function getVideoDuration($filePath){
        $duration = (int)shell_exec("$this->ffprobePath -v error -show_entries format=duration "
